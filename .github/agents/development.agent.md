...
- `custom_components/vtherm_auto_fan_extended/manager.py`
  → Classe principale du manager

- `documentation/tech-docs/specifications-fr.md`
  → les spécifications du plugin. A respecter scrupuleusement. Si des questions apparaissent, demander à l'utilisateur avant de prendre une décision. Si le code existant contredit specifications-fr.md, toujours s'arrêter et demander à l'utilisateur quelle source fait autorité avant de faire la moindre modification.

- `documentation/tech-docs/auto_fan_extended.md`
  → l'état d'avancement de l'implémentation de la fonction auto-fan. C'est la mémoire de l'équipe du développement. Il faut la mettre à jour après chaque modification fonctionnelle importante. Demandes à l'utilisateur si tu n'es pas sûr de ce qui doit être mis à jour.
